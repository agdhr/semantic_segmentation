...
from tensorflow.keras.layers import (MaxPooling2D, AveragePooling2D, UpSampling2D,
                                     Conv2DTranspose, GlobalAveragePooling2D,
                                     Conv2D, DepthwiseConv2D, Lambda,
                                     BatchNormalization, Activation, concatenate,
                                     multiply, add, ReLU, LeakyReLU, PReLU,
                                     ELU, Softmax)

def decode_layer(X, channel, pool_size, unpool, kernel_size=3, activation='ReLU',
                 batch_norm=False, name = 'decode'):
    """
...
def encode_layer(X, channel, pool_size, pool, kernel_size='auto', activation='ReLU',
...
def Res_CONV_stack(X, X_skip, channel, res_num, activation='ReLU', batch_norm=False,
                   name='res_conv'):
    """
...
def Sep_CONV_stack(X, channel, kernel_size=3, stack_num=1, dilation_rate=1, activation='ReLU', batch_norm=False,
                   name='sep_conv'):
    '''
